...
from .superadmin import tambah, daftar, cari, cari_email, hapus
...
from .manajemen import Manajemen, MANAJEMEN_KIND
from .manajemen import tambah, cari_email, ubah

from .surat import Surat, SURAT_KIND
from .surat import tambah, daftar, detail
